...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("volt_neural", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "volt_neural" is the name you will use in your source code to
                // import this module (e.g. `@import("volt_neural")`). The name is
                // repeated because you are allowed to rename your imports, which
                // can be extremely useful in case of collisions (which can happen
                // importing modules from different packages).
                .{ .name = "volt_neural", .module = mod },
            },
        }),
    });

    // Compile C++ wrapper for NAM library
    exe.addCSourceFile(.{
        .file = b.path("src/nam_wrapper.cpp"),
        .flags = &.{
            "-std=c++20",
            "-fPIC",
        },
